...
export class AdminSidebarComponent implements OnDestroy {
  ...
  private defaultCollapsedLinks(): SidebarItem[] {
    return [
      ...
      { label: 'Accounts & Billing', route: '/accounts/dashboard',      icon: this.svg('M9 7h6M9 11h6m-6 4h3m-5 6h10a2 2 0 002-2V7a2 2 0 00-.586-1.414l-3-3A2 2 0 0015 2H7a2 2 0 00-2 2v15a2 2 0 002 2z') },
