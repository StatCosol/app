...
export class AdminSidebarComponent implements OnDestroy {
  ...
  private defaultCollapsedLinks(): SidebarItem[] {
    return [
      ...
      { label: 'Payroll Templates', route: '/admin/payroll/templates',   icon: this.svg('M9 17v-6h13v6M9 7h13M5 7h.01M5 11h.01M5 15h.01M4 3h16a1 1 0 011 1v16a1 1 0 01-1 1H4a1 1 0 01-1-1V4a1 1 0 011-1z') },
      { label: 'Payroll Client Settings', route: '/admin/payroll/client-settings', icon: this.svg('M4 6a2 2 0 012-2h12a2 2 0 012 2v4H4V6zm0 8h8v4a2 2 0 01-2 2H6a2 2 0 01-2-2v-4zm10 0h6v4a2 2 0 01-2 2h-2a2 2 0 01-2-2v-4z') },
    ...
    return [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Applicability Engine', route: '/admin/applicability', icon: this.svg('M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z') },
        ],
      },
      {
        label: 'Monitoring',
