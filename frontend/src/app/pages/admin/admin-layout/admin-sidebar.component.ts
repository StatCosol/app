...
<div class="px-4 py-3 border-t border-white/8 text-center space-y-0.5">
  ...
  styles: [`
    ...
    .sidebar-dark {
      ...
      box-shadow: 2px 0 16px rgba(10, 31, 68, 0.22);
    }
...
export class AdminSidebarComponent implements OnDestroy {
  ...
  private defaultCollapsedLinks(): SidebarItem[] {
    return [
      ...
      { label: 'My Work',     route: '/admin/my-work',              icon: this.svg('M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6') },
      { label: 'Automation',     route: '/admin/automation',              icon: this.svg('M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6') },
      ...
      { label: 'Service Packages', route: '/admin/service-packages',    icon: this.svg('M12 3l8 4v5c0 5-3.5 9.74-8 11-4.5-1.26-8-6-8-11V7l8-4zm-3 9l2 2 4-4') },
      ...
      { label: 'Governance Center', route: '/admin/governance', exact: true, icon: this.svg('M12 3l8 4v5c0 5-3.5 9.74-8 11-4.5-1.26-8-6-8-11V7l8-4zm-3 9l2 2 4-4') },
    ...
    return [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Applicability Engine', route: '/admin/applicability', exact: true, icon: this.svg('M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z') },
          { label: 'Engine Config', route: '/admin/applicability/config', icon: this.svg('M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4') },
        ],
      },
      {
        label: 'Monitoring',
