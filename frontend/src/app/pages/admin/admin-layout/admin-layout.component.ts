...
@Component({
  ...
  template: `
    <div class="admin-shell">
      <!-- Mobile menu toggle -->
      <button
        class="lg:hidden fixed bottom-6 right-6 z-50 p-3.5 text-white rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 ring-4 ring-white/80 role-fab-admin"
          ...
          <div class="px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-14">
              ...
              <div class="flex items-center gap-4">
                ...
                <button
                  (click)="logout()"
                  class="inline-flex items-center gap-2 px-3.5 py-1.5 text-sm font-medium text-white rounded-lg hover:opacity-90 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 role-btn-admin"
                >
