...
export class BranchSidebarComponent implements OnInit, OnDestroy {
  ...
  private applyBadges(): void {
    ...
    const badgeMap: Record<string, string> = {
      '/branch/compliance/monthly': 'MONTHLY',
      '/branch/compliance/quarterly': 'QUARTERLY',
      '/branch/compliance/half-yearly': 'HALF_YEARLY',
      '/branch/compliance/yearly': 'YEARLY',
    };

    for (const child of complianceGroup.children) {
      const key = badgeMap[child.route];
      if (key && this.badges[key as keyof SidebarBadges]) {
        const b = this.badges[key as keyof SidebarBadges];
        const total = b.overdue + b.reupload;
        child.badge = total > 0 ? total : undefined;
      }
    }
  }
  ...
  private buildNav(): SidebarItem[] {
    return [
      ...
      { label: 'Contractors',            route: '/branch/contractors',         icon: this.svg('M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z') },
      {
        ...
        expanded: false,
        children: [
          { label: 'Monthly MCD',          route: '/branch/compliance/monthly',      icon: this.svg('M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4') },
          { label: 'Quarterly Returns',    route: '/branch/compliance/quarterly',    icon: this.svg('M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z') },
          { label: 'Half-Yearly Returns',  route: '/branch/compliance/half-yearly',  icon: this.svg('M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z') },
          { label: 'Annual Returns',       route: '/branch/compliance/yearly',       icon: this.svg('M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12') },
        ],
      },
