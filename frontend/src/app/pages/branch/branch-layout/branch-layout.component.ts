            ...
            <div class="flex items-center justify-between h-14">
              ...
              <div class="flex items-center gap-5">
                ...
                <div class="hidden xl:flex flex-col items-start gap-1 ml-6 text-xs text-gray-400">
                  <a href="mailto:compliance@statcosol.com" class="flex items-center gap-1.5 hover:text-blue-600 transition-colors">
                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                    compliance&#64;statcosol.com
                  </a>
                  <a href="tel:+919000607839" class="flex items-center gap-1.5 hover:text-blue-600 transition-colors">
              ...
              <div class="flex items-center gap-4">
                ...
                <button
                  (click)="logout()"
                  class="inline-flex items-center gap-2 px-3.5 py-1.5 text-sm font-medium text-white rounded-lg hover:opacity-90 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 role-btn-branch"
                >
