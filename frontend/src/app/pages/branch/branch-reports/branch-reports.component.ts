    ...
    <div class="page-container">
          ...
          <div class="report-grid">
            @for (report of getReportsForCategory(category); track report) {
              ...
              >
                ...
                @if (report.available) {
                  <svg
                    class="w-5 h-5 text-slate-400 ml-auto flex-shrink-0"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
      ...
      @if (activeReport) {
        <div class="report-drawer">
          ...
          @if (
            !reportLoading && activeReport.key === 'registration-expiry' && reportData.length > 0
          ) {
                        ...
                        <span
                          ...
                          [ngClass]="{
                            ...
                            'bg-green-100 text-green-700':
                              r.expiryStatus === 'ACTIVE' || r.expiryStatus === 'NO_EXPIRY',
                          }"
                        >
          ...
          @if (
            !reportLoading && activeReport.key === 'audit-observations' && reportData.length > 0
          ) {
            <div class="overflow-x-auto">
              <table class="min-w-full text-sm divide-y divide-gray-200">
                <thead class="bg-gray-50">
                ...
                <tbody class="divide-y divide-gray-100">
                  @for (o of reportData; track o) {
                    <tr class="hover:bg-gray-50">
                      ...
                      <td class="px-3 py-2 max-w-xs truncate" [title]="o.observation">
                        {{ o.observation }}
                      </td>
                      <td class="px-3 py-2">
                        <span
          ...
          @if (
            !reportLoading && activeReport.key === 'compliance-summary' && reportData.length > 0
          ) {
            <div class="overflow-x-auto">
              <table class="min-w-full text-sm divide-y divide-gray-200">
                <thead class="bg-gray-50">
          ...
          @if (
            !reportLoading && activeReport.key === 'contractor-uploads' && reportData.length > 0
          ) {
            <div class="overflow-x-auto">
              <table class="min-w-full text-sm divide-y divide-gray-200">
                <thead class="bg-gray-50">
                      ...
                      <td class="px-3 py-2 text-right">
                        <span
                          ...
                          [ngClass]="{
                            ...
                            'bg-amber-100 text-amber-700':
                              r.approvalPct >= 50 && r.approvalPct < 80,
          ...
          @if (!reportLoading && reportData.length === 0) {
            <div class="text-center text-gray-500 py-8">No data found for this report.</div>
          }
        </div>
      }
    </div>
  ...
  reports: ReportItem[] = [
    {
      ...
      description: 'PF, ESIC, PT, LWF challan summary for selected month',
    ...
    {
      name: 'PF/ESIC Registration Status',
      description: 'Employee-wise PF and ESIC registration tracker',
    ...
    },
    {
      ...
      description: 'Employee and contractor headcount with M/F breakdown',
    ...
    {
      name: 'Contractor Upload Summary',
      description: 'Document upload % by contractor for selected month',
      icon: 'M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12',
      category: 'Workforce',
      available: true,
      key: 'contractor-uploads',
      modules: ['CONTRACTOR_DOCUMENTS'],
    },
    {
      name: 'Registration Expiry Report',
      description: 'All registrations with expiry dates and renewal status',
    ...
    {
      name: 'Audit Observation Report',
      description: 'Open/closed observations with aging analysis',
      icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2',
      category: 'Audits',
      available: true,
      key: 'audit-observations',
      modules: ['CONTRACTOR_AUDIT'],
    },
  ];
