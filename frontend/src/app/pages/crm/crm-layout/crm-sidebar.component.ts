...
export class CrmSidebarComponent implements OnChanges, OnDestroy {
  ...
  private defaultCollapsedLinks(): SidebarItem[] {
    return [
      ...
      { label: 'My Work', route: '/crm/my-work', icon: this.svg('M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6') },
      { label: 'Monthly Review', route: '/crm/monthly-close', icon: this.svg('M9 12l2 2 4-4M5 3h14v18H5z') },
    ...
    return [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Compliance Tasks', route: '/crm/compliance/tasks', icon: this.svg('M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4') },
          ...
          { label: 'Renewals Workspace', route: '/crm/renewals', icon: this.svg('M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15') },
          { label: 'Amendments', route: '/crm/amendments', icon: this.svg('M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z') },
          ...
          { label: 'Quotation Comparison', route: '/crm/quotation-comparison', icon: this.svg('M3 6h18M3 12h18M3 18h18M8 6v12m8-12v12') },
        ],
      },
      {
        ...
        items: [
          ...
          { label: 'Repeat NC Analytics (read-only)', route: '/crm/audit-analytics/repeat-ncs', icon: this.svg('M3 3v18h18M7 14l4-4 4 4 6-6') },
          { label: 'Reports', route: '/crm/reports', icon: this.svg('M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z') },
