...
@Component({
  ...
  imports: [RouterModule, PageHeaderComponent, LoadingSpinnerComponent, ClientContextStripComponent],
  styles: [`
  ...
  template: `
    <main class="max-w-7xl mx-auto px-4 sm:px-6 py-6">
      ...
      @if (loading) {
<ui-loading-spinner text="Loading client info..."></ui-loading-spinner>
}
