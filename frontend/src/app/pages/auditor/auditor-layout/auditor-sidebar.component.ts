...
import { filterNavigation } from '../../../shared/navigation/navigation-filter';
...
<a
          ...
          <label class="block px-3 py-2 text-sm text-white">Find a menu
            <input type="search" [(ngModel)]="searchTerm" placeholder="Search workspaces…" class="w-full rounded px-2 py-2 bg-white/10 text-white" />
          </label>
          @if (!filteredNavGroups.length) { <p class="px-3 text-sm text-white">No matching menus.</p> }
...
<div class="px-4 py-3 border-t border-white/8 text-center space-y-0.5">
        <div class="text-[10px] text-white/35">AuditXpert v1.0</div>
...
export class AuditorSidebarComponent implements OnChanges, OnDestroy {
  ...
  searchTerm = '';
  get filteredNavGroups(): SidebarGroup[] { return filterNavigation(this.navGroups, this.searchTerm); }
  ...
  private defaultCollapsedLinks(): SidebarItem[] {
    return [
      ...
      { label: 'My Work', route: '/auditor/my-work', icon: this.svg('M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6') },
      { label: 'Conduct Audit', route: '/auditor/conduct-audit', icon: this.svg('M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4') },
      ...
      { label: 'Contractor Payroll', route: '/auditor/contractor-payroll', icon: this.svg('M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-2m0-6h2a2 2 0 012 2v4a2 2 0 01-2 2h-2') },
      { label: 'Corrections & Verification', route: '/auditor/observations', icon: this.svg('M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15') },
    ...
    return [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Contractor Payroll', route: '/auditor/contractor-payroll', icon: this.svg('M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-2m0-6h2a2 2 0 012 2v4a2 2 0 01-2 2h-2') },
          { label: 'Corrections & Verification', route: '/auditor/observations', icon: this.svg('M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15') },
          { label: 'Overdue NCs', route: '/auditor/analytics/overdue-ncs', icon: this.svg('M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z') },
          { label: 'Reports', route: '/auditor/reports', icon: this.svg('M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z') },
          { label: 'Notifications', route: '/auditor/notifications', icon: this.svg('M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9') },
        ],
      },
      {
        ...
        items: [
          { label: 'AI Audit Insights', route: '/auditor/ai-audit', icon: this.svg('M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z') },
          { label: 'Repeat NC Analytics', route: '/auditor/analytics/repeat-ncs', icon: this.svg('M3 3v18h18M7 14l4-4 4 4 6-6') },
        ],
      },
    ];
  }
