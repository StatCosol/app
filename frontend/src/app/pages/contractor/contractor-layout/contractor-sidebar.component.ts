...
<div class="px-4 pt-5 pb-3">
        <div class="flex items-center gap-2.5">
          ...
          <div>
            <span class="text-white font-bold text-[17px] tracking-tight">ConTrack</span>
            <span class="block text-white/40 text-[11px] font-medium">Contractor Compliance Portal</span>
          </div>
        </div>
...
<div class="px-4 py-3 border-t border-white/8 text-center space-y-0.5">
  ...
  styles: [`
    ...
    .sidebar-dark {
      background: linear-gradient(180deg, #4C0A24 0%, #881535 50%, #6B1229 100%);
      border-right: 1px solid rgba(255, 255, 255, 0.05);
      box-shadow: 2px 0 20px rgba(61, 10, 30, 0.22);
    }
    ...
    .sidebar-search::placeholder { color: rgba(255,220,230,0.35); }
...
export class ContractorSidebarComponent implements OnChanges, OnDestroy {
  ...
  private defaultCollapsedLinks(): SidebarItem[] {
    return [
      ...
      { label: 'My Work', route: '/contractor/my-work', icon: this.svg('M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6') },
      ...
      { label: 'CLRA', route: '/contractor/clra', icon: this.svg('M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z') },
      { label: 'Generated Payroll', route: '/contractor/payroll-computation', icon: this.svg('M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-2m0-6h2a2 2 0 012 2v4a2 2 0 01-2 2h-2') },
