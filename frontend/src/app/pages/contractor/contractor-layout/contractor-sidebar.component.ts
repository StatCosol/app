  ...
  template: `
    ...
    >
      ...
      <div *ngIf="!collapsed" class="px-4 py-3 border-t border-white/8 text-center">
        <span class="text-[10px] text-white/35">ConTrack v1.0</span>
      </div>
    </aside>
  `,
  styles: [`
...
export class ContractorSidebarComponent implements OnChanges, OnDestroy {
  ...
  private defaultCollapsedLinks(): SidebarItem[] {
    return [
      ...
      { label: 'Re-uploads', route: '/contractor/reupload-requests', icon: this.svg('M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12') },
    ...
    return [
      ...
      },
      {
        ...
        items: [
          { label: 'Compliance', route: '/contractor/compliance', icon: this.svg('M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z') },
          { label: 'Tasks', route: '/contractor/tasks', icon: this.svg('M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4') },
          { label: 'Re-upload Requests', route: '/contractor/reupload-requests', icon: this.svg('M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12') },
          { label: 'Notifications', route: '/contractor/notifications', icon: this.svg('M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6 6 0 10-12 0v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9') },
        ],
      },
      {
