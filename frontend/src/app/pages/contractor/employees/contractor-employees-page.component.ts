          ...
          <table class="min-w-full divide-y divide-gray-100">
            ...
            <tbody class="divide-y divide-gray-50">
              <tr *ngFor="let emp of filteredRows" class="hover:bg-gray-50 transition-colors">
                ...
                <td class="px-4 py-3 text-center min-w-[130px]">
                  <div class="flex flex-col items-center justify-center gap-2">
                    <ng-container *ngIf="emp.status === 'PENDING_DELETE'; else availableActions">
                      ...
                      <button
                        (click)="openEdit(emp)"
                        class="inline-flex min-w-[76px] items-center justify-center rounded-full px-3 py-1 text-xs font-semibold text-indigo-700 bg-indigo-50 hover:bg-indigo-100"
                      >Edit</button>
                    </ng-container>
                    ...
                    <ng-template #availableActions>
                      <button
                        *ngIf="!emp.isActive"
                        ...
                        [disabled]="saving"
                        class="inline-flex min-w-[76px] items-center justify-center rounded-full px-3 py-1 text-xs font-semibold text-emerald-700 bg-emerald-50 hover:bg-emerald-100 disabled:opacity-50"
                      >Reactivate</button>
                    ...
                    <button
                      *ngIf="emp.isActive"
                      (click)="confirmDeactivate(emp)"
                        [disabled]="saving"
                        class="inline-flex min-w-[76px] items-center justify-center rounded-full px-3 py-1 text-xs font-semibold text-orange-700 bg-orange-50 hover:bg-orange-100 disabled:opacity-50"
                    >Deactivate</button>

                    <button
                      (click)="requestDelete(emp)"
                        [disabled]="saving"
                        class="inline-flex min-w-[76px] items-center justify-center rounded-full px-3 py-1 text-xs font-semibold text-red-700 bg-red-50 hover:bg-red-100 disabled:opacity-50"
                      >Delete</button>
                    </ng-template>
                  </div>
                </td>
