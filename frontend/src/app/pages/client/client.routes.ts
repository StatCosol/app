...
export const CLIENT_ROUTES: Routes = [
  {
    ...
    children: [
      ...
      { path: 'mobile-attendance', loadComponent: ClientMobileAttendanceComponent, canActivate: [moduleAccessGuard('CONTRACTOR_FACE_ATTENDANCE')] },
      { path: 'face-failures', loadComponent: ClientFaceFailuresComponent, canActivate: [moduleAccessGuard('CONTRACTOR_FACE_ATTENDANCE')] },
