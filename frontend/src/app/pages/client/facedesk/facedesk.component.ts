          ...
          <table class="tbl">
            ...
            @for (c of captures; track c.attendanceId) {
              <tr>
                ...
                <td>{{ c.punchType || '—' }}</td>
                <td>{{ c.confidenceScore !== null && c.confidenceScore !== undefined ? (+c.confidenceScore).toFixed(3) : '—' }}</td>
...
<div class="settings">
          ...
          <details class="col-span-2 capture-tuning">
            ...
            <div class="grid grid-cols-2 gap-3">
              ...
              <label>Min blur score (attendance) <span class="hint">0 = off</span><input type="number" step="0.1" [(ngModel)]="settings.captureTuning.minBlurAttendance" class="inp"></label>
