...
<div class="px-4 pt-5 pb-3">
        <div class="flex items-center gap-2.5">
          <div class="w-8 h-8 rounded-lg bg-brand-500/20 flex items-center justify-center flex-shrink-0">
            <svg class="w-4.5 h-4.5 text-brand-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export class ClientSidebarComponent implements OnInit, OnChanges, OnDestroy {
  ...
  private moduleForRoute(route: string): string[] | null {
    ...
    if (route.startsWith('/client/contractor-payroll')) return ['CONTRACTOR_AUDIT', 'CONTRACTOR_DOCUMENTS', 'PAYROLL'];
  ...
  private defaultCollapsedLinks(): SidebarItem[] {
    return [
      ...
      { label: 'Monthly Review', route: '/client/monthly-close', icon: this.svg('M9 12l2 2 4-4M5 3h14v18H5z') },
    ...
    return [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Kiosk Attendance', route: '/client/facedesk', icon: this.svg('M15 10.5a3 3 0 11-6 0 3 3 0 016 0zM12 3a9 9 0 100 18 9 9 0 000-18z') },
          ...
          { label: 'Biometric Devices', route: '/client/biometric', icon: this.svg('M12 11c0-1.1.9-2 2-2s2 .9 2 2c0 2.5-1 4.5-2 6M8 11a4 4 0 018 0M5 11a7 7 0 0114 0M12 15v3') },
