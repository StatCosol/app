        ...
        <div class="section-card">
          ...
          <div class="section-grid">
            ...
            <div class="form-field">
              ...
              <input autocomplete="off" id="cef-date-of-birth" type="date" class="form-date-input" [(ngModel)]="form.dateOfBirth" name="dateOfBirth" (change)="onDobChange()" />
            ...
            <div class="form-field">
              <label class="form-label" for="cef-marital-status">Marital Status</label>
              <select id="cef-marital-status" name="maritalStatus" [(ngModel)]="form.maritalStatus" class="form-input">
