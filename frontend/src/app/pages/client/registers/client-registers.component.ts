  ...
  template: `
    <div class="page">
      <ui-page-header
        ...
        [subtitle]="isBranch ? 'Approved registers for your branch' : 'All registers for your organization'">
      ...
      <ui-empty-state
        *ngIf="!loading && !error && rows.length === 0"
        ...
        [description]="isBranch ? 'No approved registers available for your branch.' : 'No registers match the current filters.'">
      </ui-empty-state>
