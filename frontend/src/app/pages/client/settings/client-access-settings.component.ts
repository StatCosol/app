...
@Component({
  ...
  template: `
    <div class="page">
      ...
      @if (loading) {
<ui-loading-spinner text="Loading settings..."></ui-loading-spinner>
}
      @if (!loading && error) {
...
<div class="mb-4 p-3 rounded-xl bg-amber-50 border border-amber-200 text-sm text-amber-900">
        ...
        <div class="space-y-4">
          ...
          <div class="pt-2 border-t border-gray-100">
            ...
            @if (model.payrollBranchScope === 'SELECTED') {
<div class="ml-6 border border-gray-200 rounded-xl bg-gray-50 p-3">
...
<div class="text-xs text-gray-400 py-2">No branches found.</div>
}
              <div class="space-y-1 max-h-56 overflow-y-auto">
                @for (b of branches; track b) {
<label class="flex items-center gap-2 py-1 px-1 rounded hover:bg-white cursor-pointer">
                  ...
                  @if (b.branchCode) {
<span class="text-xs text-gray-400 font-mono">({{ b.branchCode }})</span>
}
                </label>
}
              </div>
