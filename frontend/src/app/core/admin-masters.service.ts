...
export class AdminMastersService {
  ...
  listComplianceMasters(): Observable<any> {
    return this.http.get(`${this.baseUrl}/api/v1/admin/masters/compliances`);
  }

  getComplianceMaster(id: string): Observable<any> {
    return this.http.get(`${this.baseUrl}/api/v1/admin/masters/compliances/${id}`);
  }

  createComplianceMaster(data: any): Observable<any> {
    return this.http.post(`${this.baseUrl}/api/v1/admin/masters/compliances`, data);
  }

  updateComplianceMaster(id: string, data: any): Observable<any> {
    return this.http.put(`${this.baseUrl}/api/v1/admin/masters/compliances/${id}`, data);
  }
  ...
  createAuditCategory(data: { name: string; description?: string }): Observable<any> {
    return this.http.post(`${this.baseUrl}/api/v1/admin/masters/audit-categories`, data);
  }

  updateAuditCategory(id: string, data: any): Observable<any> {
    return this.http.put(`${this.baseUrl}/api/v1/admin/masters/audit-categories/${id}`, data);
  }

  deleteAuditCategory(id: string): Observable<any> {
    return this.http.delete(`${this.baseUrl}/api/v1/admin/masters/audit-categories/${id}`);
  }
}
