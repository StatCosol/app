...
Write-Host "7. Testing unauthorized access (should fail)" -ForegroundColor Yellow
try {
    $response = Invoke-RestMethod -Uri "http://localhost:3000/api/admin/dashboard/summary" -Method Get
