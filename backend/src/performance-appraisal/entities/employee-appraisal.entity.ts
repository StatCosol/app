...
export class EmployeeAppraisalEntity {
  ...
  @Column({ name: 'manager_status', type: 'varchar', length: 30, nullable: true })
  managerStatus: string | null;

  @Column({ name: 'branch_status', type: 'varchar', length: 30, nullable: true })
  branchStatus: string | null;

  @Column({ name: 'client_status', type: 'varchar', length: 30, nullable: true })
  clientStatus: string | null;

  @Column({ name: 'attendance_score', type: 'numeric', precision: 5, scale: 2, nullable: true })
  attendanceScore: number | null;

  @Column({ name: 'kpi_score', type: 'numeric', precision: 5, scale: 2, nullable: true })
  kpiScore: number | null;

  @Column({ name: 'competency_score', type: 'numeric', precision: 5, scale: 2, nullable: true })
  competencyScore: number | null;

  @Column({ name: 'total_score', type: 'numeric', precision: 5, scale: 2, nullable: true })
  totalScore: number | null;

  @Column({ name: 'final_rating_code', type: 'varchar', length: 30, nullable: true })
  finalRatingCode: string | null;

  @Column({ name: 'final_rating_label', type: 'varchar', length: 100, nullable: true })
  finalRatingLabel: string | null;

  @Column({ name: 'recommendation', type: 'varchar', length: 50, nullable: true })
  recommendation: string | null;

  @Column({ name: 'recommended_increment_percent', type: 'numeric', precision: 5, scale: 2, nullable: true })
  recommendedIncrementPercent: number | null;

  @Column({ name: 'recommended_increment_amount', type: 'numeric', precision: 12, scale: 2, nullable: true })
  recommendedIncrementAmount: number | null;

  @Column({ name: 'recommended_new_ctc', type: 'numeric', precision: 12, scale: 2, nullable: true })
