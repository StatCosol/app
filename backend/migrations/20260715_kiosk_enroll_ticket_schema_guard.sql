-- Guard migration for environments that received the original kiosk ticket
-- table but missed the later review/capture columns. The backend writes these
-- columns during kiosk-supervised enrollment submit/auto-approval.
